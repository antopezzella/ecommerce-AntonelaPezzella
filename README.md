...
<p><strong>Plantasia</strong> fue diseñada con el fin de mostrar una app de venta de plantas, utilizando los servicios de Firebase dando lugar a consultas de ordenes de compra, y para mostrar los productos y su descripción. Haciendo mas intuitiva e interactiva con librerias de animacion, tambien implementa desde el formulario de contacto enviar las consultas a un e-mail personal.</p>
